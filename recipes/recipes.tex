...
% recipe
\recipeheader{Cheesy Baked Penne with Tomato, Spinach and Roasted Red Peppers}{5}{25}{2}
\begin{ingredients}
    \ingredient{8oz}{frozen spinach}
    \ingredient{12oz}{marinara sauce}
    \ingredient{5oz}{penna pasta}
    \ingredient{8oz}{ricotta cheese}
    \ingredient{6oz}{roasted red bell peppers}
    \ingredient{$\frac{1}{2}$ cups}{shredded cheese, Italian blend}
\end{ingredients}
\begin{instructions}
    \item Preheat oven to \temp{400}{F}.
    \item Prepare pasta according to package directions; drain.
    \item Meanwhile, medium dice peppers and set aside.
    \item Place spinach in a colander.
    \item When the pasta is done, drain in the colander over the spinach; return pasta and spinach to the pan.
    \item Add diced peppers, marinara sauce and ricotta to the pan with the pasta and spinach; stir to combine.
    \item Place pasta over medium heat and cook, stirring occasionally, until just warmed through, 1--2 minutes. Transfer pasata to a baking dish and top with cheese.
    \item Place baking dish in the oven and bake until cheese is melted and sauce is bubbly, 10--12 minutes. Remove from oven.
    \item To servce, divide pasta bake between plates or bowls.
\end{instructions}
\footnotetext[1]{From Mealime}
\newpage
...
% recipe
\recipeheader{Chickpea Stew}{10}{10}{4}
\commentary{
    Pick up a load of your favorite crusty bread to serve along with this chock-full-of vegetables stew.\footnotemark[1]\footnotemark[2]
}
\begin{ingredients}
    \ingredient{1}{large onion, chopped}
    \ingredient{1}{medium green sweet pepper, chopped}
    \ingredient{3 cloves}{garlic, minced}
    \ingredient{2 tsp}{cooking oil}
    \ingredient{1$\frac{1}{2}$ tsp}{ground cumin}
    \ingredient{$\frac{1}{2}$ tsp}{paprika}
    \ingredient{$\frac{1}{4}$ tsp}{red pepper}
    \ingredient{2 cups}{vegetable broth}
    \ingredient{1$\frac{1}{2}$ cups}{water}
    \ingredient{1 package}{10oz frozen whole kernel corn}
    \ingredient{2 tbsp}{snipped fresh oregano}
    \ingredient{1 can}{15oz chickpeas, rised and drained}
    \ingredient{1}{medium tomato, chopped}
    \ingredient{2 tbsp}{lemon juice}
    \ingredient{1 oz}{crumbed feta cheese}
    \ingredient{2 tbsp}{sliced green onion}
\end{ingredients}
\begin{instructions}
    \item In a large saucepan cook onion, sweet pepper, and garlic in hot oil until onion is tender, stirring occasionally. Stir in cumin, paprika, and ground red pepper; cook 1 minute more.
    \item Carefully add broth, the water, frozen corn, and oregano. Bring to boiling; reduce heat. Cover and simmer for 5 to 10 minutes or until corn is tender. Stir in chickpeas, tomato, and loemon jice. Heat through.
    \item To serve, ladle stew into bowls. Sprinkle with feta chese and green onion.
\end{instructions}
\footnotetext[1]{From pg \vegbook{170}}
\footnotetext[2]{Nutrition Facts per serving: 239 calories, 7g total fat, 6mg cholesterol, 886mg sodium, 41g carbohydrates, 10g protein.}
\newpage
...
% recipe
\recipeheader{Grilled Oregano Tofu with Spicy Marinated Tomatoes and Rice}{15}{15}{2}
\begin{ingredients}
    \ingredient{$\frac{1}{2}$ cups}{basmati rice}
    \ingredient{1}{12oz package extra firm tofu}
    \ingredient{2 clove}{garlic}
    \ingredient{$\frac{1}{2}$ small bunch}{flat-leaf parsley}
    ...
    \ingredient{1$\frac{1}{2}$ tsp}{brown sugar}
    \ingredient{1 tsp}{salt}
    \ingredient{1 tbsp}{soy sauce}
    \ingredient{1 tsp}{oregano, dried}
    \ingredient{$\frac{1}{4}$ tsp}{black pepper}
\end{ingredients}
\begin{instructions}
    \item Cut tofu in half along the long side. Sandwich tofu between clean towls or paper towels and place on baking sheet pan. Place a cutting boartd with something heavy on top and set aside to press out excess water.
    \item Using a strainer or colander, rinse the rice under cold, running water, then drain and transfer to a small saucepan. Add water and bring the mixture to a boil over high heat.
    \item Meanwhile, peel and mice garlic. Place in a medium bowl along with oil, vinegar, sugar, and salt. Whisk to combine and marinade and set aside.
    \item Once the liquid comes to a boil, stir the mixture, cover the saucepan, and reduce heat to low. Cook rice until liquid is fully absorbed, 15--18 minutes. Once done, remove rice from the heat and let it stand, still covered, for 5 minutes.
    \item While the rice is cooking, wash and dry fresh produce.
    \item Quarter jalapeno pepper lengthwise; seed and remove ribs with a spoon to reduce spiuce level, then mince. Add to a bowl with the marinade.
    \item Trim, seed, and small dice bell pepper. Add to the bowl.
    \item Halve tomatoes lengthwise, then cut into $\frac{1}{2}$-inch thich wedges. Add to the bowl.
    \item Shave parsley leaves off the stems; discard stems and mince the leaves. Add to the bowl, stir to combine, and set aside.
    \item Preheat skillet.
    \item While the pan heats up, cut tofu planks in half, then cut each half into two triangles. Place in another medium bowl, add soy sauce and spices, then gently stir to coat.
    \item Once the grill pan is got, coat with oil; add tofu and grill until charred and warmed through, 3--4 minutes per side. Remove to a plate and loosely cover with aluminum foil.
    \item To servce, divide rice, tofu, and marinated tomatoes between plates or bowls. Enjoy!
\end{instructions}
\footnotetext[1]{From Mealime}
\newpage
...
% recipe
\recipeheader{Thai Basil Chicken}{20}{10}{2}
\commentary{This Thai basil chicken recipe is one of the most popular Thai street food dishes. The chicken is
stir-fried with Thai holy basil and served on top of rice with a fried egg on the side.\footnotemark[1]\footnotemark[2]}
\begin{ingredients}
    \ingredient{1 cup}{jasmine rice, uncooked}
    \ingredient{2}{eggs}
    \ingredient{4 tbsp}{vegetable oil}
    \ingredient{2}{chicken breast}
    \ingredient{7 cloves}{garlic}
    \ingredient{4--10}{Thai chilli peppers}
    \ingredient{2 tsp}{oyster sauce}
    \ingredient{1 tsp}{light soy sauce}
    \ingredient{1 tsp}{dark sweet soy sauce}
    \ingredient{1 tsp}{sugar}
    \ingredient{2 handfuls}{Thai holy basil leaves}
\end{ingredients}
\begin{instructions}
    \item First cook the rice following the directions on the bag and fry the eggs in 2 tablespoons of vegetable oil. Set the eggs aside for later.
    \item Rinse the chicken breast in cold water and pat dry with some paper towel. Then chop the chicken into bite-sized pieces.
    \item Rinse and peel the cloves of garlic and flatten them with the side of a knife. Remove the stems from the Thai chilli peppers. Then mince both the garlic and the chillies together. Alternatively, you can use a mortar and pestle to do this if you have one. This will help bring out the flavours when frying them in oil.
    \item Rinse off your holy basil leaves in cold water and set them aside to dry off. Make sure to remove the stems from the leaves.
    \item Heat 2 tablespoons of vegetable oil in a pan or wok over high heat. When the oil is hot, add in the minced chillies and garlic. Stir-fry them for 20 seconds or until they become fragrant.
    \item Then add in your chicken and stir constantly. Continue stirring and frying them until the chicken is completely cooked through. If you find that the chicken has become dry, add in a tiny splash of water.
    \item After, add in the oyster sauce, light soy sauce, sugar and dark sweet soy sauce. Stir until the sauces and chicken are mixed well.
    \item Grab your basil and toss it into the pan and fold it into the chicken. Then immediately turn off and remove the pan from the heat. The holy basil needs to only cook for around 5 seconds. Cooking the basil for too long will make it lose some of its flavours and become chewy. It will continue to wilt and its flavour will mix with the chicken with the existing heat.
    \item Scoop a portion of rice onto each plate and place one egg on top. Split the Thai basil chicken between the two plates and garnish with a couple of basil leaves. Ready to serve.
\end{instructions}
\footnotetext[1]{From \href{https://www.dumplingconnection.com/recipes/thai-basil-chicken-recipe/}{Dumpling Connection}}
\newpage
